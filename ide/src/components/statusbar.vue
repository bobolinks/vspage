<template>
  <div class="iPhoneX-StatusBar"
    ...
    <div class="StatusBarTime" style="display: flex; flex-direction: row">12:00</div>
    <div class="StatusBarBattery" style="display: flex; flex-direction: row">
...
.iPhoneX-StatusBar .StatusBarWifi {
  margin-right: 0.4em;
}
</style>
